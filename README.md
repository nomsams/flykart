...
- **Track set** defaults to the original Grand loop. It also supports Switchback, Zigzag, Hairpin, Oval sprint, the **Sharp turn · corner test**, or **Generalist · all tracks**.
