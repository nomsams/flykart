...
- **Adaptive time limit** can extend an improving candidate from 1,500 to 3,000 and then 6,000 ticks. The first extension requires a non-negative recent reward rate; the second requires that rate to improve over the previous interval.
