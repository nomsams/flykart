...
The companion [machine-learning guide](https://nomsam.github.io/flykart/machine-learning.html) explains the controller, sensor vector, reward function, evolutionary training loop, and sim-to-real limitations.
